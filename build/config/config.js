...
const MYSQL_HOST = process.env.MYSQL_HOST || 'localhost'; //'127.0.0.1'
const MYSQL_DATABASE = process.env.MYSQL_DATABASE || 'u833865262_bettersathi'; //'admin_matrimony'
const MYSQL_USER = process.env.MYSQL_USER || 'u833865262_bettersathi'; //'astroguru_user'
const MYSQL_PASSWORD = process.env.MYSQL_PASSWORD || '@P;PiInk7^E'; //'Ns@#2022'
const MYSQL = {
    host: MYSQL_HOST,
...
const EMAILMATRIMONYSETPASSWORD = {
    fromName: "BetterSathi Sogdo",
    fromEmail: "noreply@bettersathi.com",
    subject: "Link to reset password",
    html: '<span>Hi [NAME],</span> \n\n <p>Below is the link to verify your account and new Password of your login</p>\
    \n\n <span style="font-weight:bolder; font-size:x-large; color:grey"><a href ="https://admin.bettersathi.com/reset-password/[VERIFICATION_TOKEN]">Click to Verify</a></span><br>  <span>Thank You, <br> BetterSathi Team</span>'
};
